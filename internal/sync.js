...
const { ChainId } = require("@kukuswap/sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the kukuswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("kukuswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/kukuswap/icons/master/token/${icon}.jpg`;
